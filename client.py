...
img=(Image.open('no_im.jpg'))
img=img.resize((400,300))
img=ImageTk.PhotoImage(img)
label = Label(frame,image=img,text=name, compound="top", fg="black", font=("Arial", 16,"bold"))
...
entry.insert(0,'enter message(msg:name),:all for boradcast')
entry.grid(row=0,column=0,padx=50)
entry1=Entry(frame1,width=60,fg='grey', highlightthickness=1, highlightbackground="green")
entry1.insert(0,'enter file(file:name):all for boradcast')
entry1.grid(row=0,column=1,padx=10)

f2=Frame(root)
f2.grid(sticky='w')
b=Button(f2,text='send_message')
b.grid(row=0,column=0,padx=180)
b3=Button(f2,text='send_file')
b3.grid(row=0,column=2,padx=(160,60))
...
f3=Frame(root)
f3.grid(sticky='w')
d=Button(f3,text='disconnect',command=end)
d.grid(row=0,column=0,padx=400,pady=10)
m=Frame(root)
m.grid(sticky='w')
label4 = Label(m,text='Notifications: ',font=("Arial", 16))
label4.grid(row=0,column=0,padx=70,pady=20)
label5 = Label(m,font=("Arial", 16))
label5.grid(row=1,column=0,padx=50)
label6 = Label(m,font=("Arial", 16))
label6.grid(row=2,column=0,padx=50)
label7 = Label(m,font=("Arial", 16))
label7.grid(row=3,column=0,padx=50)
label8 = Label(m,font=("Arial", 16))
